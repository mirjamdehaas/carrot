...
def main():
    ...
    strLogFile = "logs/client-foo1.log"
    ...
    logging.info("register fooOne")
    sendMessage(sock,"register:fooOne")
    ...
    try:
        while True:
            ...
            sendMessage(sock,"call:tablet.fooTwo.foo|1.0")
