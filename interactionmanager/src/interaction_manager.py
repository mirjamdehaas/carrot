...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, default="worst", help="Value could be: 'no' or 'worst' or 'best'")
    parser.add_argument("--sgroups", nargs="+", help="List of Skillgroups e.g.: 'color' 'size'")
    parser.add_argument("--L1", type=str, default="English", help="German, English, Turkish")
    parser.add_argument("--L2", type=str, default="English", help="German, English, Turkish")
    parser.add_argument("--rnr", type=int, default=36, help="The count of rounds to be played.")
